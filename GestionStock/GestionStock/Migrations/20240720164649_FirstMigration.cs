        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroArticle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NbrProduits = table.Column<int>(type: "int", nullable: false),
                    TechnicienId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductHistories_AspNetUsers_TechnicienId",
                        column: x => x.TechnicienId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Commandes_TechnicienId",
                table: "Commandes",
                column: "TechnicienId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductHistories_TechnicienId",
                table: "ProductHistories",
                column: "TechnicienId");

            migrationBuilder.CreateIndex(
                name: "IX_Products_TechnicienId",
                table: "Products",
                column: "TechnicienId");
        }
